...
project: str = 'gen_rv64asm'
project_copyright: str = '2025, Vladimir Roncevic <elektron.ronca@gmail.com>'
author: str = 'Vladimir Roncevic <elektron.ronca@gmail.com>'
version: str = '1.0.2'
release: str = 'https://github.com/vroncevic/gen_rv64asm/releases'
...
htmlhelp_basename: str = 'gen_rv64asmdoc'
latex_elements: Dict[Any, Any] = {}
latex_documents: List[Tuple[Any, ...]] = [(
    master_doc, 'gen_rv64asm.tex', 'gen\\_autoconf Documentation',
    'Vladimir Roncevic \\textless{}elektron.ronca@gmail.com\\textgreater{}',
    'manual'
)]
man_pages: List[Tuple[Any, ...]] = [(
    master_doc, 'gen_rv64asm', 'gen_rv64asm Documentation', [author], 1
)]
texinfo_documents: List[Tuple[Any, ...]] = [(
    master_doc, 'gen_rv64asm', 'gen_rv64asm Documentation', author,
    'gen_rv64asm', 'One line description of project.', 'Miscellaneous'
)]

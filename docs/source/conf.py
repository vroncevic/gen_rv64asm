...
latex_documents: list[tuple[object, ...]] = [(
    root_doc, 'gen_rv64asm.tex', 'gen_rv64asm Documentation',
    'Vladimir Roncevic \\textless{}elektron.ronca@gmail.com\\textgreater{}',
    'manual'
)]
man_pages: list[tuple[object, ...]] = [(
    root_doc, 'gen_rv64asm', 'gen_rv64asm Documentation', [author], 1
)]
texinfo_documents: list[tuple[object, ...]] = [(
    root_doc, 'gen_rv64asm', 'gen_rv64asm Documentation', author,

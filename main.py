...
def main() -> bool:
    '''
        Bootstraps and runs the gen_rv64asm with required adapters.

        :return: True if successful, False otherwise.
        :exceptions: None
    '''
    gen_rv64asm: GenRV64ASM = GenRV64ASM(GenRV64ASMBundleFactory.create_bundle())

    return gen_rv64asm.process()


if __name__ == '__main__':
    '''
        Entry point for gen_rv64asm execution.

...
Info
    GenRV64ASM bundle dependencies for the gen_rv64asm bundle.
'''
...
class GenRV64ASMBundleDependencies(TypedDict):
    '''
        GenRV64ASM bundle dependencies for the gen_rv64asm bundle.
        ...
        It defines:
            ...
            :attributes:
                | base - The base bundle with the base components for the gen_rv64asm bundle.
                | service - The service orchestrating the gen_rv64asm's execution for the gen_rv64asm bundle.
                | subprocessor - The adapter executing the gen_rv64asm's sub-processes for the gen_rv64asm bundle.
                | cli - The command-line interface adapter for the gen_rv64asm bundle.
    '''

...
Info
    Defines class GenRV64ASMPro with attribute(s) and method(s).
...
class GenRV64ASMPro(FileCheck, ProConfig, ProName):
    '''
        Defines class GenRV64ASMPro with attribute(s) and method(s).
        Generates module file by template and parameters.

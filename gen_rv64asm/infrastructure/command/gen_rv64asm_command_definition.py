...
Info
    Defines GenRV64ASMCommandDefinition class.
'''
...
class GenRV64ASMCommandDefinition:
    '''
        CLI subcommand metadata definition for rv64asm project files generation.
    ...
    def help_text(self) -> str:
        ...
        '''
        return 'Generate rv64asm project files'
    ...
    def options(self) -> Sequence[OptionData]:
        ...
        return [
            OptionData(
                name="--name",
                help_text="RV64ASM project name",
                action=None,
                default="mytool",
                required=True,
                choices=None,

...
from gen_rv64asm.infrastructure.cli.setup.options import CLIBundleOptions
from gen_rv64asm.infrastructure.cli.setup.opt_validator import CLIBundleOptionsValidator
from gen_rv64asm.infrastructure.cli.setup.bundle import CLIBundle
from gen_rv64asm.infrastructure.cli.setup.keys import CLIBundleKeys
...
from gen_rv64asm.infrastructure.command.icommand_executor import ICommandExecutor
...
class CLIBundleFactory:
    ...
    def create_bundle(cls, options: CLIBundleOptions) -> CLIBundle:
        ...
        service_definition: ICommandDefinition = GenRV64ASMCommandDefinition()
        service_executor: ICommandExecutor = GenRV64ASMCommandExecutor(definition=service_definition)
